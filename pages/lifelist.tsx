  ...
  return (
    <Container className="mb-10 flex-1">
      ...
      <div className="prose lg:prose-xl prose-zinc prose-a:text-blue-600 hover:prose-a:text-blue-500">
        <p>
          Считаю, что в жизни надо попробовать «всё» (в рамках закона, конечно).
          Заметил, что ищу кучу отговорок, чтобы попробовать новое. Лайфлист —
          это регулярно пополняющийся список вещей, которых я ещё не делал или
          долго откладывал.
        </p>
        <figure>
          <blockquote>
        ...
        <p>
          ...
          раз не получилось. В этот раз хочу документировать всё в блоге. Иначе
          зачем он создавался?
        </p>
        <p>
          Увидел идею Лайфлиста у{' '}
          <a href="https://skaplichniy.ru/note/lifelist/">Сергея Капличного</a>.
        </p>
